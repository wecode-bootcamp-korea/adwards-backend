    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.DecimalField(decimal_places=4, max_digits=20)),
                ('price_per_view', models.DecimalField(decimal_places=4, max_digits=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('quiz_history', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='advertisement.QuizHistory')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='user.User')),
            ],
            options={
